<template>
    <div>
        <!-- 하단 네비게이션바 -->
        <somoim-comment-navigation :commentable_id="form.commentable_id" :commentable_type="form.commentable_type" @created="(obj) => this.updateComment(obj)" />
...
z
<script>
import somoimCommentNavigation from '@/components/somoim/somoimCommentNavigation.vue'
export default {
    components: {
        somoimCommentNavigation
    },
    props: {
        commentable_id: {
            required: true
