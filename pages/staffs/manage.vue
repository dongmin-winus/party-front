<template>
	<div class="area-region-activity">
		...
		<div class="container">
			...
			<StaffList v-if="selectedCategory === 1" :rep_district_id="$route.query.rep_district_id"
				:rep_district_name="$route.query.rep_district_name" />
			<Approvals v-if="selectedCategory !== 1" :propToggleList="selectedCategory" />
