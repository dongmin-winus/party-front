                    ...
                    <div class="rankings mt-12">
                        ...
                        <div class="ranking-wrap second" v-if="popularRankings.length >= 2">
                            <div class="ranking" >
                                ...
                                <div class="fragment">
                                    <h3 class="title">
                                        2<span class="rank">위</span> <span class="name">{{ this.replaceText(popularRankings[1].name, 3) }}</span>
                                    </h3>
                        ...
                        <div class="ranking-wrap first" v-if="popularRankings.length >= 1">
                            <div class="ranking" >
                                ...
                                <div class="fragment">
                                    <h3 class="title">
                                        1<span class="rank">위</span> <span class="name">{{ replaceText(popularRankings[0].name, 3) }}</span>
                                    </h3>
                                    <div class="subtitle-container">
                        ...
                        <tbody>
                            <tr v-for="(item,index) in popularRankings" :key="index">
                                <template v-if="index >= 3 && item">
                                    ...
                                    <td class="orangee">{{ item.register_count }}</td>
                                    <td class="orangee">{{ item.post_count }}</td>
                                    <td class="orangee">{{ item.share_count }}</td>
                                    <td class="orangee">{{ item.like_count }}</td>
                                </template>
