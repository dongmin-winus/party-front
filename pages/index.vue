        ...
        <div style="padding-top:30px">
            ...
            <div class="fragment" v-show="district && district.id != 0">
                <section class="section-ad">
                    <client-only>
                        <carousel :adjustableHeight="true" :loop="true" :per-page="1" :autoplay="true"
                            :autoplay-timeout="5000" :mouse-drag="false" :pagination-enabled="false">
                ...
                <section class="mt-12 section-webtoon">
                    ...
                    <client-only>
                        <carousel :adjustableHeight="true" :loop="true" :per-page="1" :autoplay="true"
                            :autoplay-timeout="5000" :mouse-drag="false" :pagination-enabled="true"
                            ...
                            <nuxt-link :to="`/somoim/${item.id}`">
                                <div class="meeting" v-if="item.img && index == 0">
                                    <div class="image-container" :style="getBackground(item.img)">
                                        ...
                                        <p class="meeting-title"><span class="board">&#91;{{ item.formatBoard
                                        }}&#93;</span>&nbsp;{{ replaceText(item.title, 18) }}</p>
                                    </div>
                                </div>
                        ...
                        <swiper :options="swiperOptions">
                            <swiper-slide v-for="(slide, index) in promotionList" :key="slide.id">
                                <nuxt-link :to="`/posts/${slide.id}`">
                                    <div class="content">
                                        <div
                                            style="position:relative; border:1px solid #bdbdbd; border-radius:10px; height:inherit;">
                                            <div class="recommend">
                                                <span style="color:white;">{{ new Date().getMonth() + 1 }}월추천</span>
                                            </div>
                                            <img class="img" :src="slide.video_thumbnail" alt="-" />
                                            <div class="mt-8"></div>
                                            <p style="font-weight:500; font-size:20px; color:#0BAF00" align="center">
                                                {{ seperateString(slide.title, '/')[0] }}</p>
                                            <p style="display:block; margin: 0 15px; font-weight:300; font-size:16px; overflow:hidden; white-space:nowrap"
                                                align="center" v-html="seperateString(slide.title, '/')[1]"></p>
                                        </div>

                                    </div>
                                </nuxt-link>
                                <div class="mt-8"></div>
                                <nuxt-link :to="`/posts/${activePromotionId}`" class="m-btn type02 bg-revert-primary">자세히보기
                                    +</nuxt-link>
            ...
            <section class="section-ranking"
                :style="`${$auth.user ? ($store.state.district.id !== 0 ? '' : 'background-color:#F7F7F7; padding:24px 0;') : 'background-color:#F7F7F7; padding:24px 0;'}`">
                <div class="wrap">
                    <div class="content">
                        <div class="m-title type01">
                        ...
                        <div class="m-input-checkboxes"
                            :class="`${$auth.user ? ($store.state.district.id !== 0 ? 'type01' : 'type05') : 'type05'}`">
                            <div class="mt-8"></div>
                        ...
                        <div class="rankings">
                            ...
                            <div class="ranking-wrap second" v-if="districtRegisterCounts.length >= 2"
                                ...
                                <div class="ranking" @click="changeDistrictInRanking({
                                    ...
                                    <div class="img-wrap">
                                        ...
                                        <img src="@/assets/images/rankings/main_ranking_2nd.png" width="100px" alt=""
                                            class="img-rect">
                                    ...
                                    <div class="fragment">
                                        ...
                                        <div class="subtitle-container">
                                            ...
                                            <div class="badge" v-if="getBadgeSrc(rankingCount(districtRegisterCounts[1]))">
                                                <img
                                                    :src="require(`@/assets/images/${getBadgeSrc(rankingCount(districtRegisterCounts[1]))}`)" />
                                            </div>
                                        </div>
                                        <div :class="getScaleClass(rankingCount(districtRegisterCounts[1]), 'ranked')">
                                            ...
                                            <template v-else>
                                                <span class="tri">▲</span>&nbsp;<span style="color:#DC2626"> {{
                                                    rankingCount(districtRegisterCounts[1]) }} </span>
                                            </template>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ranking-wrap first" v-if="districtRegisterCounts.length >= 1">
                                <div class="ranking" @click="changeDistrictInRanking({
                                    ...
                                    <div class="img-wrap">
                                        <!-- <img src="https://dotmzh1fysixs.cloudfront.net/1016/crown.png" width="20px" alt="" class="deco"> -->
                                        <img src="@/assets/images/rankings/main_ranking_1st.png" width="100px" alt=""
                                            class="img-rect">
                                    ...
                                    <div class="fragment">
                                        ...
                                        <div class="subtitle-container">
                                            ...
                                            <div class="badge" v-if="getBadgeSrc(rankingCount(districtRegisterCounts[0]))">
                                                <img
                                                    :src="require(`@/assets/images/${getBadgeSrc(rankingCount(districtRegisterCounts[0]))}`)" />
                                            </div>
                                        </div>
                                        <div :class="getScaleClass(rankingCount(districtRegisterCounts[0]), 'ranked')">
                                            ...
                                            <template v-else>
                                                <span class="tri">▲</span>&nbsp;<span style="color:#DC2626"> {{
                                                    rankingCount(districtRegisterCounts[0]) }} </span>
                                            </template>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ranking-wrap third" v-if="districtRegisterCounts.length >= 3">
                                <div class="ranking" @click="changeDistrictInRanking({
                                    ...
                                    <div class="img-wrap">
                                        <!-- <img src="https://dotmzh1fysixs.cloudfront.net/1016/crown.png" width="20px" alt="" class="deco"> -->
                                        <img src="@/assets/images/rankings/main_ranking_3rd.png" width="100px" alt=""
                                            class="img-rect">
                                    ...
                                    <div class="fragment">
                                        ...
                                        <div class="subtitle-container">
                                            ...
                                            <div class="badge" v-if="getBadgeSrc(rankingCount(districtRegisterCounts[2]))">
                                                <img
                                                    :src="require(`@/assets/images/${getBadgeSrc(rankingCount(districtRegisterCounts[2]))}`)" />
                                            </div>
                                        </div>
                                        <div :class="getScaleClass(rankingCount(districtRegisterCounts[2]), 'ranked')">
                                            ...
                                            <template v-else>
                                                <span class="tri">▲</span>&nbsp;<span style="color:#DC2626"> {{
                                                    rankingCount(districtRegisterCounts[2]) }} </span>
                                            </template>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="wrapper" v-if="districtRegisterCounts.length > 3">
                            <ul class="m-table type01 rank-container">
                                <li v-for="(districtRegisterCount, index) in districtRegisterCounts" :key="index" @click="changeDistrictInRanking({
                                        ...
                                        <div class="rank">
                                            <div class="left">
                                                <div class="petit-image">
                                                    <img :src="require(`@/assets/images/rankings/${index + 4}.png`)" alt=""
                                                        srcset="">
                                                </div>
                                                ...
                                                <div>
                                                    {{ districtRegisterCount.state }} {{ districtRegisterCount.city }}
                                                    {{ districtRegisterCount.district }}
                                                </div>
                                            </div>
                                            <div class="right">
                                                <div class="badge" v-if="getBadgeSrc(rankingCount(districtRegisterCount))">
                                                    <img
                                                        :src="require(`@/assets/images/${getBadgeSrc(rankingCount(districtRegisterCount))}`)" />
                                                </div>
                                                <div :class="getScaleClass(rankingCount(districtRegisterCount))">
                                                    <span class="tri">▲ </span>&nbsp;<span> {{
                                                        rankingCount(districtRegisterCount) }} </span>
                                                </div>
                                            </div>
            ...
            <section class="section-ad">
                <client-only>
                    <carousel :adjustableHeight="true" :loop="true" :per-page="1" :autoplay="true" :autoplay-timeout="2000"
                        :mouse-drag="false" :pagination-enabled="true" :pagination-position="'bottom'">
                                    ...
                                    <div class="story-container">
                                        ...
                                        <div class="content-container">
                                            <p style="font-size:20px; font-weight:500"
                                                v-html="replaceText(slide.title, 10)">
                                            </p>
                                            <p style="color:#777; overflow:hidden;" v-html="replaceText(slide.content, 10)">
                                            </p>
                                        </div>
                                    </div>
                                </nuxt-link>
            ...
            <section class="section-popular">
                <div class="wrap">
                    ...
                    <ul class="m-table type01 rank-container mt-32">
                        <li v-for="(item, index) in popularRankings" :key="index" :style="getOpacity(index)">
                            <div class="rank">
                                <div class="left">
                                    <div class=" fixed-width">
                                ...
                                <div class="right">
                                    ...
                                    <div class="bar">
                                        <div class="bar-inner"
                                            :style="`width:${getPopularPercentage(item)}%; background:${getBarColor(item)}`">
                    ...
                    <div class="content">
                        ...
                        <div :class="`card-${partyClass}`" v-if="partyClass">
                            ...
                            <div class="card-content-container">
                                <div class="card">
                                    <div class="card-image" :style="`background-image:url('${congressmanItem.img.url}')`">
                                    </div>
                                </div>
                                <p style="font-size:30px; font-weight:700;">{{ congressmanItem.korean_name }} 의원</p>
                                <div class="activity-point">
                                    <span>활동만족도</span> &nbsp;<img :src="require(`@/assets/images/${makeAvgImg}`)"
            ...
            <section class="section-ad">
                <client-only>
                    <carousel :adjustableHeight="true" :loop="true" :per-page="1" :autoplay="true" :autoplay-timeout="5000"
                        :mouse-drag="false" :pagination-enabled="false">
            ...
            <quicks :createUrl="'/posts/create'" :btnName="'글쓰기'" />
        </div>

        <navigation />
        <Finder v-if="activeFinder" :title="'주소로 행정동 찾기'" :excecute="'변환하기'" :cancel="'검색하기'" @cancel="closeModal"
            @setContainer="setContainer" />
        <modal v-if="activateNoticePop" :noPaddingModal="true" :paddingModal="false" :cancelBtn="false"
            :btnTransparent="true" @cancel="activateNoticePop = false">
            ...
            <template #outter>
                ...
                <client-only>
                    ...
                    <carousel ref="noticeCarousel" :adjustableHeight="false" :loop="true" :per-page="1" :autoplay="true"
                        @input="listenAutoplay" :autoplay-timeout="3000" :mouse-drag="false" :pagination-enabled="false">
                        <slide class="swiper-slide modal" v-for="(slide, index) in noticePopupContents" :key="slide?.id">
                            <a :href="slide?.link_url" target="_blank" class="link">
                                <img class="img" v-if="slide?.media[0]" :src="slide.media[0].original_url" alt="-">
                            </a>
                        </slide>
                    </carousel>
                </client-only>
                <div class="btn-container">
                    <div style="padding-left:10px;">
                        <button class="btn" @click="closeAllDay()">오늘 하루 보지 않기</button>
                    </div>
                    <div style="padding-right:10px;">
                        <button class="btn" @click="justClose()">닫기 X</button>
                    </div>

                </div>
                <!-- <div v-for="(content, index) in noticePopupContents" :key="index" v-show="content.id === getCurrentId">
                    ...
                    <div class="btn-container">
                        <div style="padding-left:10px;">
                            <button class="btn" @click="closeAllDay(content, index)">오늘 하루 보지 않기</button>
                        </div>
                        <div style="padding-right:0px;">
                            <button class="btn" @click="justClose(content, index)">닫기 X</button>
                        </div>
