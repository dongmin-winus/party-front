    ...
    <div class="container">
      <div class="content">
        ...
        <div class="form-container">
          <SurveyItem v-for="(item, index) in buildArrWoHeader" :key="index" :item="item" :form_id="31" @valueChange="valueChange" />
...
export default {
  ...
  async mounted() {
    ...
    const response = await this.$axios.$get('/api/forms/option/31')
    this.form_id
